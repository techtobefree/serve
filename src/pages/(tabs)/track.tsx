...
import {
  Category,
  filterSearchToCategories,
} from "../../domains/search/search";
        ...
        <>
          ...
          <div className="flex justify-center m-1">
            <div className="max-w-[600px] flex-1 flex-col gap-2 flex">
              {isAdminError && (
                <div className="text-3xl p-3">Error loading projects</div>
              )}
              {isAdminLoading && (
                <>
                  <PulsingCard />
...
const Track = observer(() => {
  return <TrackComponent userId={userStore.current?.id} />;
});
