    ...
    Edit any time by expanding the profile icon in the top right corner.`}
                    ...
                    <div className='flex flex-col gap-4'>
                      ...
                      ${new Date().getTime().toString()}`)
                            ...
                            <div className='absolute top-0 right-0'><PublicIcon /></div>
                        </div>
                        <IonItem>
                                ...
                                <div>
                                    <IonButton color='secondary'
                                        ...
                                        onClick={() => {
                                            ...
                                            void changeHandle(userId, `${profile.first_name || ''} ${profile.last_name || ''}`)
                                        }}>Copy name</IonButton>
                                </div>
                                <div>
                                    <IonInput label='Display name*'
                                        value={user.handle}
                                        onIonChange={(e) => {
                    ...
                    <div className='flex flex-col gap-4 p-2'>
                        ...
                        <Link className='cursor-pointer text-blue-500'
                            to='/terms'>Read full terms and conditions</Link>
                    </div>
                    {!acceptedAt && (
                        <>
                            <IonItem>
                    ...
                    {acceptedAt && (
                        <>
                            ...
                            <IonButton
                                className='p-4 self-end'
                                onClick={() => { navigate('/home') }}>Home</IonButton>
                        </>
                    )}
                    <br />
                </div>
